...
**Revisit when:** never, without an explicit decision to reverse the single-thread model — consistent with D-47's own revisit clause, which this entry supersedes.
