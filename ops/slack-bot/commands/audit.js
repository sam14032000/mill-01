...
const SYSTEM_PROMPT = [
	...
	"mode (brainstorm, product, engineering, proto). Every claim in it carries exactly one source tag. Only ONE of",
	"those tags marks something you may count as evidence:",
	"",
	"  COUNTS toward evidence_basis:",
	"    • [SOURCE: research-<stamp>] — drawn from an actual research pass.",
	"    (Plus the raw field notes and prototype outcomes passed to you separately, which you grade yourself.)",
	"",
	"  NEVER counts toward evidence_basis:",
	"    • [FOUNDER BELIEF] — a founder's unsourced assertion.",
	"    • [SURFACE SEARCH — not evidence] — an unverified web lookup. No sources checked, no citation re-check.",
	"      Treat it as no better than a founder belief that happens to cite a headline.",
	"    • [RELAYED — not field evidence] — a founder's paraphrase of a conversation. This is the founder's own",
	"      characterisation of their field evidence, which you must not accept (see the grading rule below). A",
	"      [RELAYED …] item is at most a hint that a conversation happened and its notes should be looked for --",
	"      it can never by itself justify field-intent, field-behaviour or field-committed. Graded field evidence",
	"      comes only from the raw field notes and prototype outcomes passed to you separately.",
	"",
	"A reference doc full of confident [FOUNDER BELIEF] and [RELAYED …] claims and no [SOURCE: research-…] is an",
	"idea with no evidence, however well-argued it reads. Grade it that way.",
	"",
